...
import com.mmtechy.commerce.domain.Client;
import com.mmtechy.commerce.repository.ClientRepository;
...
/**
 * REST controller for managing {@link com.mmtechy.commerce.domain.Client}.
 */
@RestController
@RequestMapping("/api")
@Transactional
        ...
        Optional<Client> result = clientRepository
            ...
            .map(
                existingClient -> {
                    ...
                    if (client.getLocalisation() != null) {
                        existingClient.setLocalisation(client.getLocalisation());
                    }
