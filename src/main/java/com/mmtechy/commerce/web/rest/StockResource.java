...
/**
 * REST controller for managing {@link com.mmtechy.commerce.domain.Stock}.
 */
@RestController
@RequestMapping("/api")
@Transactional
            ...
            .map(
                existingStock -> {
                    if (stock.getDateEntree() != null) {
                        existingStock.setDateEntree(stock.getDateEntree());
                    }
                    if (stock.getFournisseur() != null) {
                        existingStock.setFournisseur(stock.getFournisseur());
                    }
                    if (stock.getLibelle() != null) {
                        existingStock.setLibelle(stock.getLibelle());
                    }
                    if (stock.getQuantite() != null) {
                        existingStock.setQuantite(stock.getQuantite());
                    }
                    if (stock.getMontantAchatTTC() != null) {
                        existingStock.setMontantAchatTTC(stock.getMontantAchatTTC());
                    }
                    if (stock.getDatePaiement() != null) {
                        existingStock.setDatePaiement(stock.getDatePaiement());
                    }
